              ...
              <Card className="mb-6">
                ...
                <CardContent className="p-0">
                  ...
                  <div className="p-6">
                    ...
                    <h2 className="text-3xl font-bold mb-1">{prod.name as unknown as string}</h2>
                    <p className="text-md text-muted-foreground mb-4 mt-2 ml-1">
                        CAS: {prod.cas_number}
                    </p>
                    ...
                    <div className="grid grid-cols-2 gap-2 text-base">
                      {prod.property.map((prop, index) => (
                        <div key={index}>
                          <p className="font-medium text-xl">{prop.name as unknown as string}</p>
                          <p className="text-md text-muted-foreground ml-1">{prop.numeric ?? prop.value}  {prop.unit?.unit.en}</p>
                        </div>
                      ))}
                      {/* <div>
                      ...
                      <div className="mt-12">
                        <p className="font-medium text-xl">Packaging:</p>
                        <p className="text-md text-muted-foreground">{prod.packaging as unknown as string}</p>
                      </div>
                    </div>
